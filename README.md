...
2. If you prefer to see your data being tracked in real time using visualizations, you can run `main.py` by using `fastapi run main.py --host 127.0.0.1`. You will be able to select what PIDs you want to see and it will display each one on a chart. They only downside is you need internet connection so using your phone as a hotspot may be needed.
# Future Plans
